...
Complementariamente a la información básica disponible en la Wikipedia, en los siguiente enlaces se encuentra una discusión detallada acerca de este tipo de patrones arquitecturales, con sus utilidades y diferencias. Martin Fowler, su autor, es un autor ampliamente conocido en el campo del diseño software.
